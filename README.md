...
This is a backend-only service. If you're looking for the web frontend application, take a look at https://github.com/sparksevo/insight-ui.
...
- [Resources](#resources)
- [License](https://github.com/sparksevo/insight-api-sparks/blob/master/LICENSE)
...
- [Bitcore Node sparks 3.x](https://github.com/sparksevo/sparkscore-node)
...
```
With all the configuration options available: https://github.com/sparksevo/insight-api/blob/master/lib/ratelimiter.js#L10-17
